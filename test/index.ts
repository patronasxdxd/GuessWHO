...
describe("Battleship", function () {
  it("Should play properly", async function () {
    ...
    await battleship.connect(account2).submitMove(0, 1, 3, proof5.solidityProof, false);
    game = await battleship.game(0);
    ...
    await battleship.connect(account1).submitMove(0, 1, 1, proof6.solidityProof, false);
    game = await battleship.game(0);
...
const createWC = require('/Users/gilleszwijsen/battlesnark/circom/create/create_js/witness_calculator.js');
const createWasm = './circom/create/create_js/create.wasm'
const createZkey = './circom/create/create_0001.zkey'
const moveWC = require('/Users/gilleszwijsen/battlesnark/circom/create/create_js/witness_calculator.js');
